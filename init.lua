...
require('lazy').setup({
  ...
  { -- Fuzzy Finder (files, lsp, etc)
    ...
    config = function()
      ...
      vim.keymap.set('n', '<leader>sr', builtin.oldfiles, { desc = 'Search [R]ecent' })
  ...
  },
  {
    ...
    config = function()
      ...
      -- Mason does not have a "gleam" package; we use system `gleam lsp`
      for i = #ensure_installed, 1, -1 do
        if ensure_installed[i] == 'gleam' then
